...
и FSM; выход из Up снимает Poll этого перехода. Очередь изменений параметров и
их полные commit/timer semantics ещё не реализованы. Это не полное соответствие
Section 6.5.
...
не изменены; динамические Poll-транзакции и FRR/BIRD-квалификация остаются открытыми.
