...
> Кросс-имплементационный анализ бенчмарков, сравнивающий GoBFD (Go 1.27) с FRR bfdd и BIRD3 (C): кодек-операции, переходы FSM, полный путь пакета, масштабирование сессий и поведение при нагрузке на CPU. Все числа получены из воспроизводимых микро-бенчмарков, запущенных в Podman-контейнерах.
