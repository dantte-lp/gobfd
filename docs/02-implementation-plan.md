...
| **S7** | Independent production integration assets. | In progress: generic runbooks, Kubernetes manifest hardening, and Prometheus rule correction are done; FRR/GoBGP examples and optional public vendor examples remain. Commit: `feat(examples): add production integration assets`. |
