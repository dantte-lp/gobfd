...
добавлен, включая NetworkManager-aware owner policy. Linux
bond/team/OVS/NetworkManager backend ещё не добавлен, поэтому полный RFC 7130
enforcement в Linux остаётся следующим implementation step.
