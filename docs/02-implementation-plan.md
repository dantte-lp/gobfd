...
| Auth wiring | Partial | YAML-defined sessions now wire RFC 5880 auth into session TX/RX and expose auth type in snapshots; gRPC key management is intentionally rejected until API fields exist. |
