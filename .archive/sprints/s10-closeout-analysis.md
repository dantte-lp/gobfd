...
| P2 | Broader vendor NOS execution | Implemented in S11.3 for public images | Public SR Linux, SONiC-VS, VyOS, and FRR images are exercised; cEOS and XRd remain operator-provided or licensed |
