...
| **S11** | Full E2E and interoperability execution. | In progress: S11.1-S11.3 implemented; S11.5 local Podman release gate passes after vendoring Protovalidate proto for Buf lint; release blocker closeout отслеживается в `docs/ru/23-s11-release-blocker-closeout-plan.md`. |
