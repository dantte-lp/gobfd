...
| **S11** | Full E2E and interoperability execution. | In progress: S11.1-S11.3 implemented; S11.5 имеет local Podman release gate evidence, Buf remote access и strict GoBGP vulnerability gates задокументированы как release blockers. |
