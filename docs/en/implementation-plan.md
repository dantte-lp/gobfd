...
| **S11** | Full E2E and interoperability execution. | In progress: S11.1-S11.3 are implemented; S11.5 has local Podman release gate evidence with Buf remote access and strict GoBGP vulnerability gates documented as release blockers. |
