...
При 5.96 нс/оп GoBFD может маршалить **167 миллионов пакетов в секунду** на одном ядре. BFD при 1,000 сессиях с интервалами 100 мс требует 10,000 пакетов/сек — у нас запас в 16,700x.
...
При 52.94 нс/оп GoBFD может демультиплексировать **18.9 миллионов пакетов в секунду**. При 1,000 сессиях с интервалами 100 мс реальная нагрузка — 10,000 пакетов/сек — у нас запас в 1,890x.
