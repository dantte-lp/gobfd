...
> Проекция состояния Beads, сверенная 2026-09-07. Реестр задач находится в
...
Milestone по-прежнему зависит от `gobfd-qj0.8.1`: приёмка ожидает решения
maintenance-задач, при этом текущая разработка дочерних задач v1 может продолжаться.
