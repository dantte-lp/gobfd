...
| Required remote action | Push fix and verify the next PR-safe workflow run. |
...
| Remote CI evidence | Push the PR-safe E2E fix, rerun PR-safe/nightly/manual profiles in GitHub Actions, and attach artifacts. |
